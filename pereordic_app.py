...
if score == 3:
    st.success("🎉 คุณชนะแล้ว!")
elif score >= 1:
    st.info("ไปจำมาอีกนิดนะ ขนาดจำเรื่องของคนเก่ายังจำได้เลย")
else:
    st.error("คุณแพ้แล้ว ลองเริ่มต้นใหม่ดูนะ ถึงแม้จะเริ่มต้นใหม่กับคนเก่าไม่ได้ก็ตาม")
